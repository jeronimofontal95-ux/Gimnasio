...
export default function Home() {
  return (
    <div className="forja-shell bg-[#0A0A0A]">
      {/* Photo at the top, like the original cover */}
      <div className="relative h-[280px] w-full shrink-0 overflow-hidden sm:h-[320px]">
        <Image
          src="/trainer.jpg"
          alt="Entrenador"
          fill
        ...
        />
        <div
          className="absolute inset-x-0 bottom-0 z-[1] h-[140px]"
          style={{ background: "linear-gradient(to bottom, rgba(10,10,10,0) 0%, #0A0A0A 92%)" }}
        />
        <div
          className="absolute left-0 top-0 z-[2] h-0 w-0"
          style={{ borderTop: "90px solid #9CFF3D", borderRight: "76px solid transparent" }}
        />
      ...
      <div className="relative z-[2] -mt-2 px-[22px]">
        <p className="mb-3.5 text-sm font-extrabold" style={{ color: "#9CFF3D" }}>
          <span className="block leading-[1.6]">✕✕</span>
          <span className="block leading-[1.6]">✕✕</span>
          <span className="block leading-[1.6]">✕✕</span>
        </p>
        <h1
          className="font-display mb-3 text-[46px] uppercase leading-[0.95] text-white sm:text-[56px]"
